/**
 * Locality Map Hierarchy & Density Engine (Runtime JavaScript)
 *
...
import { hasLocalityBoundary } from './localityBoundaries.js';
import { computeLocalityRelevanceTier } from './localityVisualRelevance.js';
 ...
 */
export function getLocalityZoomTier(latitudeDelta) {
 ...
 */
export function isVerifiedBoundaryLocality(locality) {
 ...
 */
export function getAuthoritativeAreaScore(item) {
    if (!item) return null;
 ...
 */
export function getClusterZoomRegion(cluster, currentRegion) {
    if (!cluster.bounds) {
